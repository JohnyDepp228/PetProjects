...
#
get_filename_component(filename "C:/Users/Boss/Desktop/BankProject/Bank/docs/build/_deps/doxygen-awesome-css-tmp/main.zip" ABSOLUTE)
get_filename_component(directory "C:/Users/Boss/Desktop/BankProject/Bank/docs/build/_deps/doxygen-awesome-css-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-doxygen-awesome-css${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-doxygen-awesome-css${i}")
